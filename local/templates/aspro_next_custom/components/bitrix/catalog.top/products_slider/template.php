...
<?if($arResult["ITEMS"]):?>
	...
	<div class="common_product wrapper_block" id="<?=$sliderID?>">		
		...
		<div class="all_wrapp">
			<div class="content_inner tab flexslider loading_state shadow border custom_flex top_right" data-plugin-options='{"animation": "slide", "animationSpeed": 600, "directionNav": true, "controlNav" :false, "animationLoop": true, "slideshow": false, "touch": true, "counts": [4,3,3,2,1]}'>
				<ul class="tabs_slider items slides">
					<?foreach($arResult["ITEMS"] as $key => $arItem):?>
						...
						<li id="<?=$this->GetEditAreaId($arItem['ID']);?>" class="catalog_item visible unified-product-card">
