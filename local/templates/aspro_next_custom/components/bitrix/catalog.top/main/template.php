			...
			<div class="image_wrapper_block">
				...
				<a href="<?=$arItem["DETAIL_PAGE_URL"]?>" class="thumb shine">
					...
					<?if(!empty($arItem["PREVIEW_PICTURE"])):?>
						<?$img = CFile::ResizeImageGet($arItem["PREVIEW_PICTURE"], array("width" => 600, "height" => 600), BX_RESIZE_IMAGE_PROPORTIONAL, true );?>
						<img src="<?=$img["src"]?>" loading="lazy" alt="<?=$a_alt;?>" title="<?=$a_title;?>" />
