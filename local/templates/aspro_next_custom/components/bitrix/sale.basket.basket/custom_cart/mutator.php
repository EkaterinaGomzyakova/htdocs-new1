...
{
	$availableQuantity = CNext::GetTotalCount(['ID' => $row['PRODUCT_ID']], ['STORES' => \WL\SnailShop::getDefaultStore()['ID']]);
...
/*
* WL: отображение рекомендаций по сумме заказа
*/
ob_start();
global $APPLICATION;
$APPLICATION->IncludeComponent(
    "wl:basket.discount.advice",
    "",
    [
		"TARGETS" => [
			"DOLYAMI_PAYMENT" => 5_000,
			"FREE_DELIVERY_LIPETSK" => 5_000,
			"FREE_DELIVERY_RUSSIA_PVZ" => 5_000,
			"FREE_DELIVERY_RUSSIA_COURIER" => 7_000,
		],
	]
);

$result['WL_BASKET_DISCOUNT_ADVICE'] = ob_get_contents();
ob_end_clean();
?>