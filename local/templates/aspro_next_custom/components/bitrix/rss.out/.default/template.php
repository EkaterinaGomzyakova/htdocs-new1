...
<rss version="2.0"<?if($arParams["YANDEX"] == "Y") echo ' xmlns="http://backend.userland.com/rss2" xmlns:yandex="http://news.yandex.ru"';?>>
<channel>
...
<item<?if($arParams["YANDEX"] == "Y") {?> turbo="true"<? } ?>>
	...
	<description>
		<![CDATA[
			...
			<?= htmlspecialchars("<br>");?>
			<?= htmlspecialchars('<a href="' . CHTTP::URN2URI("", $arResult["SERVER_NAME"]). '">' . CHTTP::URN2URI("", $arResult["SERVER_NAME"]) . '</a>');?>
		]]>
	</description>
