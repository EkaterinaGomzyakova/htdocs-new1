				...
				<? } else { ?>
					...
					<script>
						if (arNextOptions['THEME']['USE_FORMS_GOALS'] !== 'NONE') {
							var eventdata = {
								goal: 'goal_webform_success' + (arNextOptions['THEME']['USE_FORMS_GOALS'] === 'COMMON' ? '' : '_<?= $arResult["arForm"]["ID"] ?>')
							};
				...
				<script type="text/javascript">
					$(document).ready(function() {
						...
						if (arNextOptions['THEME']['PHONE_MASK'].length) {
							...
							$('form[name=<?= $arResult["arForm"]["VARNAME"] ?>] input.phone, form[name=<?= $arResult["arForm"]["VARNAME"] ?>] input[data-sid=PHONE]').inputmask('mask', {
