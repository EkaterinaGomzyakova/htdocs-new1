		...
		<table>
			<tr>
				<?foreach($arResult as $arItem):?>
					...
					?>
					<td class="menu-item <?= $arItem['PARAMS']['SECTION']['CODE']?> unvisible <?=($arItem["CHILD"] ? "dropdown" : "")?> <?=($bWideMenu ? 'wide_menu' : '');?> <?=(isset($arItem["PARAMS"]["CLASS"]) ? $arItem["PARAMS"]["CLASS"] : "");?>  <?=($arItem["SELECTED"] ? "active" : "")?>">
						<div class="wrap">
