...
<div class="item projects-blocks">
	...
	<div class="head-block<?= ($arResult['GALLERY'] ? '' : ' wti') ?>">
		<div class="row">
			<?php if (is_array($arResult['GALLERY']) && count($arResult['GALLERY']) > 1) { ?>
				<div class="col-md-7 col-sm-7">
					<div class="inner">
						<ul class="slides owl-carousel items1">
							<?php foreach ($arResult['GALLERY'] as $i => $arPhoto) { ?>
								<li class="slide">
			...
			<?php } else { ?>
				<div class="col-xs-12 col-sm-7 col-md-5">
					<div class="inner">
						<img src="<?= $arResult['GALLERY'][0]['PREVIEW']['src'] ?>" class="img-responsive inline" title="<?= $$arResult['GALLERY'][0]['TITLE'] ?>" alt="<?= $arResult['GALLERY'][0]['ALT'] ?>" itemprop="image" />
					</div>
				</div>
			<?php } ?>
			<div class="<?= ($arResult['GALLERY'] ? 'col-md-5 col-sm-5' : 'col-md-12 col-sm-12'); ?>">
				<div class="info" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
					<?php if (isset($arResult['PROPERTIES']['TASK_PROJECT']) && $arResult['PROPERTIES']['TASK_PROJECT']['~VALUE']['TEXT']) { ?>
						<div class="hh">
					...
					<?php }; ?>
					<?php if ($arResult['DISPLAY_PROPERTIES_FORMATTED'] || ($bShowAskBlock || $bShowOrderBlock)) { ?>
						<div class="row">
							<?php if ($arResult['DISPLAY_PROPERTIES_FORMATTED']) { ?>
								<div class="col-md-<?= (($bShowAskBlock || $bShowOrderBlock) ? 6 : 12) ?>">
									<?php foreach ($arResult['DISPLAY_PROPERTIES_FORMATTED'] as $code => $arProp) { ?>
										<div class="prop-block">
											...
											<div class="value">
												<?php if (is_array($arProp['DISPLAY_VALUE'])) { ?>
													<?php foreach ($arProp['DISPLAY_VALUE'] as $key => $value) { ?>
														<?php if ($arProp['DISPLAY_VALUE'][$key + 1]) { ?>
															<?= $value . '&nbsp;/ ' ?>
														<?php } else { ?>
															<?= $value ?>
														<?php }; ?>
							...
							<?php }; ?>
							<?php if ($bShowAskBlock || $bShowOrderBlock) { ?>
								<div class="col-md-<?= ($arResult['DISPLAY_PROPERTIES_FORMATTED'] ? 6 : 12) ?>">
									<div class="buttons-block">
										<?php if ($bShowOrderBlock) { ?>
											<div class="block">
												<span class="btn btn-default btn-lg animate-load" data-event="jqm" data-param-form_id="<?= ($arParams["FORM_ID_ORDER_SERVISE"] ? $arParams["FORM_ID_ORDER_SERVISE"] : 'PROJECTS'); ?>" data-name="order_services" data-autoload-service="<?= $arResult['NAME'] ?>" data-autoload-project="<?= $arResult['NAME'] ?>"><span><?= (strlen($arParams['S_ORDER_SERVISE']) ? $arParams['S_ORDER_SERVISE'] : Loc::getMessage('S_ORDER_SERVISE')) ?></span></span>
											</div>
										<?php }; ?>
										<?php if ($bShowAskBlock) { ?>
											<div class="block">
												<span class="btn btn-default btn-lg white animate-load" data-event="jqm" data-param-form_id="ASK" data-name="question"><span><?= (strlen($arParams['S_ASK_QUESTION']) ? $arParams['S_ASK_QUESTION'] : Loc::getMessage('S_ASK_QUESTION')) ?></span></span>
											</div>
											<div class="text">
	...
	<div class="row">
			...
			<div class="wraps galerys-block">
				...
				<? if ($arParams['GALLERY_TYPE'] == 'small') : ?>
					<div class="small-gallery-block">
						<div class="flexslider row front bigs dark small_slider color-controls" data-plugin-options='{"animation": "slide", "directionNav": false, "useCSS": true, "controlNav" :true, "animationLoop": true, "slideshow": false, "touch": true, "counts": [4, 3, 2, 1]}'>
							...
							<div class="inner">
								<? if (count($arResult["GALLERY_BIG"]) > 1) : ?>
									<div class="small-gallery-wrapper">
										<div class="thmb1 flexslider unstyled small-gallery center-nav" data-plugin-options='{"slideshow": false, "useCSS": true, "animation": "slide", "animationLoop": true, "itemWidth": 60, "itemMargin": 20, "minItems": 1, "maxItems": 9, "slide_counts": 1, "touch": true, "asNavFor": ".gallery-wrapper .bigs"}' id="carousel1">
											<ul class="slides items">
								...
								<? endif; ?>
								<div class="flexslider dark bigs big_slider color-controls" id="slider" data-plugin-options='{"animation": "slide", "useCSS": true, "directionNav": true, "controlNav" :true, "animationLoop": true, "slideshow": false, "sync": ".gallery-wrapper .small-gallery", "touch": true, "counts": [1, 1, 1]}'>
									<ul class="slides items">
										<? foreach ($arResult['GALLERY_BIG'] as $i => $arPhoto) : ?>
		...
		<div class="col-md-3 hidden-xs hidden-sm">
			...
			<div class="ask_a_question">
				...
				<div class="outer">
					<span><span class="btn btn-default btn-lg white animate-load" data-event="jqm" data-param-form_id="ASK" data-autoload-need_product="<?= $arResult['NAME'] ?>" data-name="question"><span><?= (strlen($arParams['S_ASK_QUESTION']) ? $arParams['S_ASK_QUESTION'] : Loc::getMessage('S_ASK_QUESTION')) ?></span></span></span>
				</div>
			</div>
			<? if ($isMenu) : ?>
				<? $this->EndViewTarget(); ?>
