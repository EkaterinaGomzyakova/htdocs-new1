						...
						<tr class="soc-serv-personal">
							...
							<td class="soc-serv-name">
								...
								<div class="auth-soc-name">
									<?$arTmpUser = CUser::GetList(($by="id"), ($order="asc"), array("LOGIN_EQUAL" => $arUser['LOGIN']), array("FIELDS" => array("ID", "PERSONAL_PHONE", "PASSWORD", "PERSONAL_PHOTO")))->Fetch();?>
									<?if(intval($arTmpUser["PERSONAL_PHOTO"]) > 0):?>
