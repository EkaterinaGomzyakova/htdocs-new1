...
$MESS["EXPANDABLES_TITLE"] = "С этим товаров рекомендуют";
...
$MESS['TOOLTIP_WISHIST'] = 'Войдите или зарегистрируйтесь, чтобы добавлять товары в избранное';

$MESS['ALL_BRAND_PRODUCTS_TEXT'] = "(все товары бренда)";
$MESS['COUNT_PRODUCT_IN_BASKET'] = 'В корзине у ';
$MESS['AVAILABILITY_IN_RETAIL_TITLE'] = 'Наличие в розничных магазинах';
?>