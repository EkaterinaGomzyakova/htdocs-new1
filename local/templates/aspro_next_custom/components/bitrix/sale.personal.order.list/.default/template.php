...
if (!empty($arResult['ERRORS']['FATAL'])) {
    ...
    if (!count($arResult['ORDERS'])) {
        ...
        <div class="row col-xs-12">
            <a href="<?= htmlspecialcharsbx($arParams['PATH_TO_CATALOG']) ?>" class="btn btn-lg btn-default">
    ...
    if ($_REQUEST["filter_history"] !== 'Y') {
        ...
        foreach ($arResult['ORDERS'] as $key => $order) {
            ...
            <div class="col-md-12 col-sm-12 sale-order-list-container">
                ...
                <div class="row">
                    <div class="col-xs-12 sale-order-list-inner-container">
                        <div class="row">
                            <div class="col-sm-6 col-xs-12">
                                <div class="sale-order-list-inner-title-line">
                                    ...
                                    <div class="sale-order-list-inner-title-line-border"></div>
                                </div>
                                <?
                                $showDelimeter = false;
									...
									<span class="sale-order-list-shipment-element">
                                        ...
                                        ?>
                                            ...
                                            if (!empty($shipment['TRACKING_NUMBER'])) {
                                                ?>
                                                <div class="sale-order-list-shipment-item tracking-number-section">
                        ...
                        <div class="sale-order-list-top-border"></div>
                        <div class="sale-order-list-inner-row">
                            <? $APPLICATION->IncludeComponent("bitrix:sale.personal.order.detail", "product-list", array(
                                "SEF_MODE" => "N",
                                "ID" => $order['ORDER']['ID'],
                                "ORDERS_PER_PAGE" => "10",
                                "SET_TITLE" => "Y",
                        ...
                        <div class="sale-order-list-inner-row buttons-line">
