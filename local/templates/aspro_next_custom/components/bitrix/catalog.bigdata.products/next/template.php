	...
	<div id="<?=$injectId?>_items" class="bigdata_recommended_products_items">
		...
		<div class="viewed_slider common_product wrapper_block recomendation <?=$class_block;?>">
			...
			<div class="all_wrapp basket">
				<div class="content_inner tab flexslider loading_state shadow border custom_flex top_right" data-plugin-options='{"animation": "slide", "animationSpeed": 600, "directionNav": true, "controlNav" :false, "animationLoop": true, "slideshow": false, "controlsContainer": ".viewed_navigation", "touch": true, "counts": [5,4,3,2,1]}'>
