...
<?if( count( $arResult["ITEMS"] ) >= 1 ){?>
	<div class="viewed_block horizontal">
		...
		<div class="outer_wrap flexslider shadow items border custom_flex top_right" data-plugin-options='{"animation": "slide", "directionNav": true, "itemMargin":10, "controlNav" :false, "animationLoop": true, "slideshow": false, "touch": true, "counts": [5,4,3,2,1]}'>
