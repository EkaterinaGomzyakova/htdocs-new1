...
<?if( count( $arResult["ITEMS"] ) >= 1 ){?>
	<div class="viewed_block">
		...
		<div class="outer_wrap flexslider shadow items border custom_flex top_right" data-plugin-options='{"animation": "slide", "directionNav": true, "itemMargin":10, "controlNav" :false, "animationLoop": true, "slideshow": false, "touch": true, "counts": [8,4,3,2,1]}'>
									...
									<div class="image_wrapper_block">
										<a href="<?=$arItem["DETAIL_PAGE_URL"]?>" class="thumb">
											...
											<?if(isset($arItem["IMG"]) && $arItem["IMG"]):?>
												<img loading="lazy" src="<?=$arItem["IMG"]["src"]?>" alt="<?=$a_alt;?>" title="<?=$a_title;?>" />
											<?else:?>
