...
<div class="menu middle">
    <ul>
        <li class="counters">
            <a rel="nofollow" class="dark-color wishlist-link js-favorites-block" href="/personal/wishlist/">
                <i class="svg">
                ...
                <span>Избранное<span class="count empted"><?=$arResult['COUNT_ITEMS']?></span></span>
            </a>
        </li>
    </ul>
</div>
