<?
	...
	$MESS ['PERSONAL_EMAIL_DESCRIPTION'] = "Укажите чтобы получать письма о статусах заказов и чеки в электронном виде.";
	$MESS ["PERSONAL_NAME_DESCRIPTION"] = "Ваше имя.";
	$MESS ["PERSONAL_PHONE_DESCRIPTION"] = "Является логином для входа на сайт.";
	...
	$MESS['USER_UNSUBSCRIBE_FROM_SMS'] = "Отказаться от смс-рассылок";
    $MESS['PERSONAL_BIRTHDAY'] = "День Рождения";
    $MESS["BIRTHDAY_PLACEHOLDER"] = "Введите дату рождения";
    $MESS["PERSONAL_BIRTHDAY_DESCRIPTION"] = "Мы дарим скидку 15% в день рождения и за 3 дня до и 3 дня после дня вашего рождения.";
    $MESS["PERSONAL_BIRTHDAY_DESCRIPTION_COMPLETED"] = "Вы можете получить скидку 15% в день рождения и за 3 дня до и 3 дня после дня вашего рождения. Получение скидки возможно при предъявлении документа удостоверяющего личность. Оригинал документа при самовывозе или фотографии документа для других способов получения заказа.";
?>