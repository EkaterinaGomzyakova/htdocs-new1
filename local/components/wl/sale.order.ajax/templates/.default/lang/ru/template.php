...
$MESS["SOA_ORDER_SUC"] = "<strong>Спасибо за заказ!</strong><br>Номер заказа №#ORDER_ID#.<br>Мы уже начали его собирать.";
$MESS["SOA_PAYMENT_SUC"] = "Номер вашей оплаты: <b>№#PAYMENT_ID#</b>";
$MESS["SOA_ORDER_SUC1"] = "Вы можете следить за выполнением своего заказа в <a href=\"#LINK#\">Персональном разделе сайта</a>.";
$MESS["SOA_PAY"] = "Оплата заказа";
$MESS["SOA_PAY_LINK"] = "<p>Если окно оплаты не открылось, нажмите на кнопку</p><p><a class='btn btn-default' href=\"#LINK#\" target=\"_blank\">Оплатить заказ</a></p>";
...
$MESS["SOA_SUM_PAYED"] = "Используем бьюти-баллы:";
...
$MESS["ORDER_DEFAULT"] = "Перейти к оформлению";
...
$MESS["SOA_POPULAR_CITY_TITLE"] = "Популярные города:";
$MESS['SOA_BONUS_EARNED_TEXT'] = 'Начислится ';
$MESS['SOA_BONUS_EARNED_TEXT_MEASURE'] = 'бьюти-баллов';
$MESS['PICKUP_MESSAGE'] = "Самовывоз осуществляется из магазина по адресу г. Липецк, пр. Победы, 61Б";