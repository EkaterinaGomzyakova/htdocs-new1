...
Asset::getInstance()->addJs('/local/modules/wl.snailshop/admin/reports/wl_purchase_price/script.js');

$APPLICATION->SetTitle("Наценки и Установка розничных цен");
...
try {
    ...
    ?>
    <link rel="stylesheet" type="text/css" href="/local/modules/wl.snailshop/admin/reports/wl_purchase_price/style.css">
