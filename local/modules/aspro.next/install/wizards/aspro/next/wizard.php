...
<?include_once($_SERVER["DOCUMENT_ROOT"]."/bitrix/wizards/aspro/next/css/styles.css");?>
<script>
	<?require_once($_SERVER['DOCUMENT_ROOT']."/bitrix/wizards/aspro/next/js/jquery-1.8.3.min.js");?>
	<?require_once($_SERVER['DOCUMENT_ROOT']."/bitrix/wizards/aspro/next/js/jquery.keyboard.js");?>
	function setWizardBackgroundColor(theme){
		...
		switch (theme){
			...
			case "8":
				...
				break;
			case "9":
				$(".instal-bg").css("backgroundColor", "#1976d2");
				break;
			case "10":
...
class SelectTemplateStep extends CSelectTemplateWizardStep{
	function InitStep(){
		...
		$wizard->SetDefaultVars(Array("templateID" => "next"));
	}
	...
	function ShowStep(){
		if(!CModule::IncludeModule("aspro.next")){
			...
			{
				if(strpos($templateID, "aspro_") === false || (isset($arTemplate["TYPE"]) && $arTemplate["TYPE"] == "mail"))
...
class SelectThemeStep extends CSelectThemeWizardStep{
	...
	function ShowStep(){
		...
		$ThemeID = strtolower(COption::GetOptionString("aspro.next", "BASE_COLOR", '9', $siteID));
...
class SiteSettingsStep extends CSiteSettingsWizardStep{
	function InitStep(){
		if(CModule::IncludeModule("aspro.next")){
			...
			$arCurSiteTheme = CNext::GetBackParametrsValues($siteID);
...
class ShopSettings extends CWizardStep{
	function InitStep(){
		...
		$wizard->SetDefaultVars(
			Array(
				"shopLocalization" => COption::GetOptionString("next", "shopLocalization", "ru", $siteID),
				"shopEmail" => COption::GetOptionString("next", "shopEmail", $wizard->GetVar("siteEmail"), $siteID),
				"shopOfName" => COption::GetOptionString("next", "shopOfName", GetMessage("WIZ_SHOP_OF_NAME_DEF"), $siteID),
				"shopLocation" => COption::GetOptionString("next", "shopLocation", GetMessage("WIZ_SHOP_LOCATION_DEF"), $siteID),
				//"shopZip" => 101000,
				"shopAdr" => COption::GetOptionString("next", "shopAdr", GetMessage("WIZ_SHOP_ADR_DEF"), $siteID),
				"shopINN" => COption::GetOptionString("next", "shopINN", "1234567890", $siteID),
				"shopKPP" => COption::GetOptionString("next", "shopKPP", "123456789", $siteID),
				"shopNS" => COption::GetOptionString("next", "shopNS", "0000 0000 0000 0000 0000", $siteID),
				"shopBANK" => COption::GetOptionString("next", "shopBANK", GetMessage("WIZ_SHOP_BANK_DEF"), $siteID),
				"shopBANKREKV" => COption::GetOptionString("next", "shopBANKREKV", GetMessage("WIZ_SHOP_BANKREKV_DEF"), $siteID),
				"shopKS" => COption::GetOptionString("next", "shopKS", "30101 810 4 0000 0000225", $siteID),
				"siteStamp" => COption::GetOptionString("next", "siteStamp", $siteStamp, $siteID),

				//"shopCompany_ua" => COption::GetOptionString("next", "shopCompany_ua", "", $siteID),
				"shopOfName_ua" => COption::GetOptionString("next", "shopOfName_ua", GetMessage("WIZ_SHOP_OF_NAME_DEF_UA"), $siteID),
				"shopLocation_ua" => COption::GetOptionString("next", "shopLocation_ua", GetMessage("WIZ_SHOP_LOCATION_DEF_UA"), $siteID),
				"shopAdr_ua" => COption::GetOptionString("next", "shopAdr_ua", GetMessage("WIZ_SHOP_ADR_DEF_UA"), $siteID),
				"shopEGRPU_ua" =>  COption::GetOptionString("next", "shopCompany_ua", "", $siteID),
				"shopINN_ua" =>  COption::GetOptionString("next", "shopINN_ua", "", $siteID),
				"shopNDS_ua" =>  COption::GetOptionString("next", "shopNDS_ua", "", $siteID),
				"shopNS_ua" =>  COption::GetOptionString("next", "shopNS_ua", "", $siteID),
				"shopBank_ua" =>  COption::GetOptionString("next", "shopBank_ua", "", $siteID),
				"shopMFO_ua" =>  COption::GetOptionString("next", "shopMFO_ua", "", $siteID),
				"shopPlace_ua" =>  COption::GetOptionString("next", "shopPlace_ua", "", $siteID),
				"shopFIO_ua" =>  COption::GetOptionString("next", "shopFIO_ua", "", $siteID),
				"shopTax_ua" =>  COption::GetOptionString("next", "shopTax_ua", "", $siteID),

				"installPriceBASE" => COption::GetOptionString("next", "installPriceBASE", "Y", $siteID),
			)
		);
	}
...
class DataInstallStep extends CDataInstallWizardStep{
	...
	function CorrectServices(&$arServices){
		if($_SESSION["BX_next_LOCATION"] == "Y") $this->repeatCurrentService = true;
...
class FinishStep extends CFinishWizardStep{
	...
	function ShowStep(){
		...
		if(CModule::IncludeModule("aspro.next")){
			CNext::newAction("wizard_installed");
		}
		
		COption::SetOptionString("aspro.next", "WIZARD_DEMO_INSTALLED", "Y");
	}
}
?>