		...
		<div class="maxwidth-theme">
			<div class="col-md-12">
				...
				<div class="item-views partners front slider-items list list-type-block image_<?=$arParams["IMAGE_POSITION"];?>">
					<div class="flexslider unstyled row front dark-nav" data-plugin-options='{"directionNav": true, "controlNav" :true, "animationLoop": true, "slideshow": false, "touch": true, <?=($slideshowSpeed >= 0 ? '"slideshowSpeed": '.$slideshowSpeed.',' : '')?> <?=($animationSpeed >= 0 ? '"animationSpeed": '.$animationSpeed.',' : '')?> "counts": [<?=$countmd?>, 1, 1]}'>
