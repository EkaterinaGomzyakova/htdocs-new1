...
<?if($arResult['ITEMS']):?>
	<div class="projects item-views table with-comments">
		...
		<?endif;?>
		<div class="flexslider unstyled row front" data-plugin-options='{"animation": "slide", "directionNav": true, "controlNav" :true, "animationLoop": true, "slideshow": false, "itemMargin": 32, "touch": true, "counts": [3, 2, 1]}'>
