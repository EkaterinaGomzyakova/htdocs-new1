...
$by = "id"; $order = "asc";
$arFields = array("ACTIVE" => "Y", "EVENT_NAME" => "FORM_FILLING_FEEDBACK", "LID" => WIZARD_SITE_ID, "EMAIL_FROM" => $wizard->GetVar("siteEmail"), "EMAIL_TO" => $wizard->GetVar("siteEmail"), "SUBJECT" => GetMessage("NEW_FEEDBACK_EMAIL_SUBJECT"), "MESSAGE" => GetMessage("NEW_FEEDBACK_EMAIL_TEXT"), "BODY_TYPE" => "html");
