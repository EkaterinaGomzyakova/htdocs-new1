		...
		<div class="maxwidth-theme">
			<div class="col-md-12">
				...
				<div class="item-views front staff-items table-type-block blocks <?=($isNormalBlock ? 'normal' : '');?>">
					...
					<div class="flexslider unstyled row front dark-nav view-control navigation-vcenter" data-plugin-options='{"directionNav": true, "controlNav" :true, "animationLoop": true, "slideshow": false, "touch": true, <?=($slideshowSpeed >= 0 ? '"slideshowSpeed": '.$slideshowSpeed.',' : '')?> <?=($animationSpeed >= 0 ? '"animationSpeed": '.$animationSpeed.',' : '')?> <?=($isNormalBlock ? '"itemMargin": 32,' : '');?> "counts": [<?=$arParams['COUNT_IN_LINE']?>, <?=$arParams['COUNT_IN_LINE']-1?>, 1]}'>
