...
<div class="item projects-blocks">
		...
		<div class="row">
			<?if($arResult['GALLERY']):?>
				<div class="col-md-7 col-sm-7">
					<div class="inner">
						<div class="flexslider color-controls dark show-nav-controls bigs top_slider" data-slice="Y" data-plugin-options='{"animation": "slide", "directionNav": true, "controlNav" :true, "animationLoop": true, "touch": true, "slideshow": false}'>
	...
	if($useBrands){?>
		<?$APPLICATION->IncludeComponent("bitrix:catalog.brandblock", "main", array(
