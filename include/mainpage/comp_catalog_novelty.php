...
<!-- Блок 3: Новинка -->
<div class="custom-products-block novelty-block">
    <div class="title-container"> <h2 class="title">Новинка  <a href="/offers/novelty/" class="see-all-link">Все</a></h2></div>
	<? $APPLICATION->IncludeComponent("bitrix:catalog.section", "catalog_block_novelty", array_merge($mainComponentParams, ["FILTER_NAME" => "arrFilterNew"]), false); ?>
</div>
