<?php
global $APPLICATION, $isMenu;
require($_SERVER["DOCUMENT_ROOT"]."/bitrix/header.php");
$APPLICATION->SetTitle("Интернет-магазин косметики ClanBeauty.ru");
$APPLICATION->SetPageProperty('title', "Статьи и советы от интернет-магазина ClanBeauty.ru");
$isMenu = true;
