...
$APPLICATION->SetTitle("Бренды косметики в интернет-магазине ClanBeauty.ru");
$APPLICATION->SetPageProperty('title', "Корейские и американские бренды косметики в интернет-магазине ClanBeauty.ru");
$APPLICATION->IncludeComponent(
	...
	array(
		...
		"IBLOCK_ID" => "15",
		"IBLOCK_TYPE" => "catalog_dictionaries",
		"IMAGE_POSITION" => "left",
